...
// ShashkiKursovaya.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CShashkiKursovayaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CShashkiKursovayaApp

CShashkiKursovayaApp::CShashkiKursovayaApp()
{
...
// Единственный объект CShashkiKursovayaApp

CShashkiKursovayaApp theApp;


// Инициализация CShashkiKursovayaApp

BOOL CShashkiKursovayaApp::InitInstance()
{
